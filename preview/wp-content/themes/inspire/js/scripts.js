	...
	function saveReadLate(userId,postId,added)
		{
			if(userId !== 0)
			{
				...
				if(added === 0)
				{
					url = "https://blog.tigounebusiness.co/setArticleToListReadLater?user_id="+userId+"&post_id="+postId;
				}else{
					url = "https://blog.tigounebusiness.co/deleteArticleToListReadLater?user_id="+userId+"&post_id="+postId;
				}
				$.ajax({
					url: url, 
