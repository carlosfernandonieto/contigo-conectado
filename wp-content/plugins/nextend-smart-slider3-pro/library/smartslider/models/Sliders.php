...
class N2SmartsliderSlidersModel extends N2Model {
    ...
    private static function editForm($data = array()) {
        ...
        new N2ElementOnOff($showOnDevices, 'desktop', n2_('Desktop'), 1, array(
            'relatedFields' => array(
                'sliderdesktop-landscape'
            )
        ));
        new N2ElementOnOff($showOnDevices, 'tablet', n2_('Tablet'), 1, array(
            'relatedFields' => array(
                'tab-slider-responsive-tablet'
            )
        ));
        new N2ElementOnOff($showOnDevices, 'mobile', n2_('Mobile'), 1, array(
            'relatedFields' => array(
                'tab-slider-responsive-mobile'
            )
        ));
        ...
        new N2ElementOnOff($desktopLandscape, 'desktop-landscape', n2_('Customize'), 0, array(
            'relatedFields' => array(
        ...
        new N2ElementOnOff($tabletPortrait, 'tablet-portrait', n2_('Customize'), 0, array(
            'relatedFields' => array(
        ...
        new N2ElementOnOff($tabletLandscape, 'tablet-landscape', n2_('Customize'), 0, array(
            'relatedFields' => array(
        ...
        new N2ElementOnOff($mobilePortrait, 'mobile-portrait', n2_('Customize'), 0, array(
            'relatedFields' => array(
        ...
        new N2ElementOnOff($mobileLandscape, 'mobile-landscape', n2_('Customize'), 0, array(
            'relatedFields' => array(
        ...
        new N2ElementNumber($layerImageEmbed, 'layer-image-base64-size', n2_('Maximum file size to embed'), 50, array(
            'min'   => 0,
            'unit'  => 'kb',
            'style' => 'width:30px;'
        ));
        ...
        new N2ElementImageListFromFolderValue($loadingCore, 'spinner', n2_('Loading animation'), 'simpleWhite', array(
            ...
            'rowClass' => 'n2-white',
            'tip'      => 'This option only works with "Fade in - on load" and it doesn\'t work with "Fade in - on scroll".'
        ));
		...
		new N2ElementOnOff($slidesCore, 'reverse-slides', n2_('Reverse slides'), 0, array(
			'rowClass' => 'n2-expert'
		));
        ...
        $slideBackgroundLightbox = new N2ElementGroup($slidesCore, 'lightbox', n2_('Lightbox from slide backgrounds'), array(
            'tip' => 'This feature only works if all slides have background images.'
        ));
        ...
        new N2ElementOnOff($developerOptions, 'controlsBlockCarouselInteraction', n2_('Block carousel - Interaction'), 1, array(
            'tip'      => n2_('Blocks carousel when the source of interaction is vertical touch, vertical pointer, mouse wheel or vertical keyboard.'),
            'rowClass' => 'n2-expert'
        ));
