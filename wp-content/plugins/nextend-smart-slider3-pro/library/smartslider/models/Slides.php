...
class N2SmartsliderSlidesModel extends N2Model {
    ...
    public function simpleEditForm($data = array()) {
        ...
        if (!$this->slider->isStaticEdited || (!isset($data['static-slide']) || $data['static-slide'] != 1)) {
            ...
            $slideVideoBackground = new N2ElementGroup($slideBackground, 'background-video', n2_('Background video <br> (<a href="https://smartslider3.helpscoutdocs.com/article/1556-video-autoplay-handling/" target="_blank">Browser limitations</a>)'), array(
                'rowClass' => 'n2-ss-background-video-param',
                'tip'      => n2_('Autoplaying videos is not allowed by browsers in a lot of cases. When this happens, the selected background image displays.')
            ));
