...
class N2SSPluginItemFactoryInput extends N2SSPluginItemFactoryAbstract {
    ...
    public function renderFields($form) {
        ...
        new N2ElementNotice($settings, n2_('Please note that <b>we do not provide support</b> for the input layer. We only suggest using this layer if you are a developer.'));
        ...
        new N2ElementLinkTarget($form, 'target', n2_('Target window'));
