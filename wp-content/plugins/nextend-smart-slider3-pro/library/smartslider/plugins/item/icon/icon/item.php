...
class N2SSItemIcon extends N2SSItemAbstract {
    ...
    private function getHtml($isContent = true) {
        ...
        return '<span class="' . $styleClass . ($isContent ? ' n2-ss-item-content' : '') . ' n2-ow" style="display:block;">' . N2Html::image('data:image/svg+xml;base64,' . n2_base64_encode(str_replace(array(
                    'data-style',
                    '{style}'
                ), array(
                    'style',
