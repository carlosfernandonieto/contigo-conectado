...
class N2SSPluginTypeShowcase extends N2SSPluginSliderType {
    ...
    public function renderFields($form) {
		...
		$backgroundColor = new N2ElementGroup($settings, 'slider-background-color', n2_('Slider background color'));
		new N2ElementColor($backgroundColor, 'background-color', n2_('Color'), 'FFFFFF00', array(
			'alpha' => true
		));
		...
		new N2ElementOnoff($settings, 'slide-overlay', n2_('Switch with next/previous slides'), 1, array(
			'rowClass' => 'n2-expert'
		));
        ...
        $properties = new N2ElementGroup($animationSettings, 'showcase-animation', n2_('Main animation properties'));
        ...
        new N2ElementOnOff($animationSettings, 'carousel', n2_('Carousel'), 1, array(
            ...
            'tip' => n2_('This option will create a complete round from your slides if you have enough slides. If you don\'t have enough slides, you could consider duplicating all the slides or just add more slides until you will get a carousel round.')
        ));
