...
class N2SmartSliderTypeShowcase extends N2SmartSliderType {
    ...
    protected function renderType($css) {
        ...
        <div class="n2-ss-slider-1 n2-ss-swipe-element n2-ow">
            <div class="n2-ss-slider-2 n2-ow" style="<?php echo n2_esc_attr($sliderCSS); ?>">
                <div class="n2-ss-slider-3 n2-ow">
                    ...
                    <div class="n2-ss-showcase-slides n2-ow"><?php
                        foreach ($this->slider->slides AS $i => $slide) {
                            ...
                            )), $slide->background . N2Html::tag('div', array( 'class' => 'n2-ss-slide-inner' ) + $slide->linkAttributes, $slide->getHTML()) . ($overlay ? N2Html::tag('div', array( 'class' => 'n2-ss-showcase-overlay n2-ow' )) : ''));
                        }
                        ?></div>
                </div>
                <?php
