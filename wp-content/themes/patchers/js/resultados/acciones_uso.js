...
var valores_perei = ['63%','33%','79%','64%', '8%','16%','48%','13%','45%'];
...
var valores_medel_3 = ['83%','90%','47%','45%','33%','68%','83%','41%'];
var valores_perei_3 = ['64%','81%','48%','56%','17%','68%','88%','53%'];

var iconos_total = ['imges/foto2-tigo-une.png', 'imges/foto5-tigo-une.png', 'imges/foto6-tigo-une.png', 'imges/foto7-tigo-une.png', 'imges/foto8-tigo-une.png', 'imges/foto15-tigo-une.png', 'imges/foto16-tigo-une.png', 'imges/foto17-tigo-une.png', 'imges/foto2-tigo-une.png', ];

var textos_total = ['Tablet', 'Tu propio portátil que puedes llevar a tu habitación', 'Un celular', 'Un computador que compartes con otros miembros de tu familia', 'Un computador de escritorio que solo tu utilizas', 'Un portátil que compartes con tu familia y que no puedes llevarte a otra habitación', 'Un televisor conectado a Internet (SmartTV)', 'Un televisor conectado a Internet en tu habitación', 'Una consola de videojuego' ];

var textos_total_2 = ['Todos los días', 'Casi todos los días', 'Con menor frecuencia']

var textos_total_3 = ['En tu habitación u otra habitación privada', 'En la sala u otra habitación común de la casa', 'En el colegio', 'En un café Internet o una sala de Internet', 'En una biblioteca pública', 'En casa de un amigo', 'En casa de un familiar', 'En cualquier otro lugar por el que te mueves y puedes conectarte a través de una plataforma móvil']

//ACTIVIDADES----------------------- valores y textos

var valores_total_4 = ['84%'];
var valores_barra_4 = ['77%'];
var valores_bogot_4 = ['85%'];
var valores_bucar_4 = ['80%'];
var valores_calii_4 = ['85%'];
var valores_carta_4 = ['82%'];
var valores_maniz_4 = ['88%'];
var valores_medel_4 = ['87%'];
var valores_perei_4 = ['88%'];

var valores_total_5 = ['14%', '7%','22%','16%','18%','15%', '5%', '3%', '0%', '3%'];
var valores_barra_5 = [' 0%','15%','10%','34%','19%','21%', '0%', '3%', '0%', '0%'];
var valores_bogot_5 = ['15%','14%','18%','14%','15%','19%', '0%', '4%', '0%', '2%'];
var valores_bucar_5 = ['20%', '4%','21%','14%','26%', '6%', '8%', '0%', '0%', '0%'];
var valores_calii_5 = ['16%', '0%','20%','19%','21%','13%', '2%', '0%', '0%','11%'];
var valores_carta_5 = ['19%', '2%','20%','16%','15%','18%', '4%', '2%', '0%', '4%'];
var valores_maniz_5 = ['13%', '0%','33%','17%','25%', '8%', '4%', '0%', '0%', '0%'];
var valores_medel_5 = ['13%', '8%','25%','12%','14%','15%', '7%', '4%', '0%', '3%'];
var valores_perei_5 = ['13%', '8%','21%','16%','28%','12%', '3%', '0%', '0%', '0%'];

var valores_total_6 = ['26%','1%','1%', '7%','37%', '8%', '7%','1%','14%'];
var valores_barra_6 = ['26%','0%','0%', '9%','33%','10%','22%','0%', '0%'];
var valores_bogot_6 = ['29%','2%','0%','11%','21%', '6%','14%','0%','17%'];
var valores_bucar_6 = ['23%','0%','2%', '2%','49%', '2%', '0%','2%','20%'];
var valores_calii_6 = ['25%','0%','0%', '8%','40%', '4%', '8%','0%','16%'];
var valores_carta_6 = ['19%','0%','0%', '4%','22%','30%', '7%','0%','19%'];
var valores_maniz_6 = ['33%','0%','0%', '8%','42%', '0%', '4%','0%','13%'];
var valores_medel_6 = ['29%','1%','0%', '6%','40%', '6%', '5%','1%','13%'];
var valores_perei_6 = ['13%','0%','0%','12%','44%','16%', '4%','0%','13%'];

var valores_total_7 = ['87%','38%','59%','49%','64%','51%','57%','79%'];
var valores_barra_7 = ['90%','43%','54%','52%','71%','49%','56%','75%'];
var valores_bogot_7 = ['94%','32%','73%','55%','70%','46%','66%','82%'];
var valores_bucar_7 = ['98%','49%','55%','57%','56%','59%','72%','88%'];
var valores_calii_7 = ['98%','37%','70%','60%','74%','74%','47%','86%'];
var valores_carta_7 = ['92%','40%','65%','44%','70%','55%','58%','82%'];
var valores_maniz_7 = ['75%','29%',' 8%','46%','71%','50%','46%','75%'];
var valores_medel_7 = ['80%','35%','54%','43%','60%','43%','54%','75%'];
var valores_perei_7 = ['82%','40%',' 6%','53%','56%','55%','68%','84%'];

var textos_total_4 = ['SI']

var textos_total_5 = ['No tiene','Hasta 10','11-50','51-100','101-300','301-1000','1001-2000','2001-5000','Más de 5000','No sabe / No recuerda']

var textos_total_6 = ['WhatsApp','Twitter','Snapchat','Instagram','Facebook','Facebook Messenger','YouTube','Otras redes sociales*','Ninguna']

var textos_total_7 = ['Abrir varias pestañas en el navegador como Chrome, Firefox o Internet Explore','Cambiar las preferencias de privacidad en el navegador','Añadir una página a favoritos','Bloquear publicidad o correos no deseados','Borrar el historial de las páginas que has visitado','Cambiar los ajustes de privacidad de una red social','Encontrar información sobre cómo usar Internet de forma segura','Bloquear personas de las que no quieres saber nada']

//RIESGOS----------------------- valores y textos

var valores_total_8 = ['12%', '8%'];
var valores_barra_8 = [ '4%', '0%'];
var valores_bogot_8 = ['13%', '6%'];
var valores_bucar_8 = ['16%','13%'];
var valores_calii_8 = ['10%','21%'];
var valores_carta_8 = [ '8%', '7%'];
var valores_maniz_8 = [ '8%','13%'];
var valores_medel_8 = ['13%', '7%'];
var valores_perei_8 = ['17%', '8%'];

var valores_total_9 = ['84'];
var valores_barra_9 = ['77'];
var valores_bogot_9 = ['85'];
var valores_bucar_9 = ['80'];
var valores_calii_9 = ['85'];
var valores_carta_9 = ['82'];
var valores_maniz_9 = ['88'];
var valores_medel_9 = ['87'];
var valores_perei_9 = ['88'];

var valores_total_10 = ['84'];
var valores_barra_10 = ['77'];
var valores_bogot_10 = ['85'];
var valores_bucar_10 = ['80'];
var valores_calii_10 = ['85'];
var valores_carta_10 = ['82'];
var valores_maniz_10 = ['88'];
var valores_medel_10 = ['87'];
var valores_perei_10 = ['88'];

var valores_total_11 = ['84'];
var valores_barra_11 = ['77'];
var valores_bogot_11 = ['85'];
var valores_bucar_11 = ['80'];
var valores_calii_11 = ['85'];
var valores_carta_11 = ['82'];
var valores_maniz_11 = ['88'];
var valores_medel_11 = ['87'];
var valores_perei_11 = ['88'];

var valores_total_12 = ['84'];
var valores_barra_12 = ['77'];
var valores_bogot_12 = ['85'];
var valores_bucar_12 = ['80'];
var valores_calii_12 = ['85'];
var valores_carta_12 = ['82'];
var valores_maniz_12 = ['88'];
var valores_medel_12 = ['87'];
var valores_perei_12 = ['88'];

var valores_total_13 = ['84'];
var valores_barra_13 = ['77'];
var valores_bogot_13 = ['85'];
var valores_bucar_13 = ['80'];
var valores_calii_13 = ['85'];
var valores_carta_13 = ['82'];
var valores_maniz_13 = ['88'];
var valores_medel_13 = ['87'];
var valores_perei_13 = ['88'];

var valores_total_14 = ['84'];
var valores_barra_14 = ['77'];
var valores_bogot_14 = ['85'];
var valores_bucar_14 = ['80'];
var valores_calii_14 = ['85'];
var valores_carta_14 = ['82'];
var valores_maniz_14 = ['88'];
var valores_medel_14 = ['87'];
var valores_perei_14 = ['88'];

var valores_total_15 = ['84'];
var valores_barra_15 = ['77'];
var valores_bogot_15 = ['85'];
var valores_bucar_15 = ['80'];
var valores_calii_15 = ['85'];
var valores_carta_15 = ['82'];
var valores_maniz_15 = ['88'];
var valores_medel_15 = ['87'];
var valores_perei_15 = ['88'];


var textos_total_8 = ['SI']

var textos_total_9 = ['SI']

var textos_total_10 = ['SI']

var textos_total_11 = ['SI']

var textos_total_12 = ['SI']

var textos_total_13 = ['SI']

var textos_total_14 = ['SI']

var textos_total_15 = ['SI']
